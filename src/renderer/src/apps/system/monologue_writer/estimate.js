// Monologue writing uses ai.chat() across 4 turns
...
// Turn 1: guide + concept → 3 angles (~3000 in, ~1000 out)
// Turn 2: pick angle + beat outline (~5000 in, ~1500 out)
// Turn 3: write full monologue (~7000 in, ~4000 out)
